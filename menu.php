...
// ロゴ
echo "<p class='menu_back'><a href='menu.php'>";
echo "<img src='images/logo_over.png' width='500px' height='200px' vspace='50' hspace='30' align='left'>";
...
try {
  ...
  default:         // メニュー表示ページ
    ...
    if (isset($_SESSION["login"])) {
      ...
      echo "</form></p>";
      echo "<p><form method='POST' action='menu.php'>";
      echo "<div class='textbox'><input type='image' value='おすそわけする' class='insert' align='right'></div>";
      echo "<input type='hidden' name='h' value='おすそわけする'>";
      echo "</form></p>";
     /* echo "<p><form method='POST' action='menu.php'>";
